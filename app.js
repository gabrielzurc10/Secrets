...
mongoose.connect("mongodb+srv://admin-gabriel:"+process.env.MONGO_KEY+"@cluster0.pnnh6.mongodb.net/userDB", {useNewUrlParser: true, useUnifiedTopology: true, useFindAndModify: false});
